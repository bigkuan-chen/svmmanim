...
### SVM Kernel Trick 3D Infographic (視覺化教學總覽圖)
Below is the educational infographic poster of the project:

![SVM Kernel Trick 3D Infographic](svm_kernel_trick.png)

---

### Phase 2 output: 2D Decision Boundary & 3D Decision Surface
Below is the model confidence visualization generated by running `phase2_rbf_decision_surface.py`:
